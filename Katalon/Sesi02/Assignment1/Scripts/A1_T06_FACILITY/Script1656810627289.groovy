...
WebUI.selectOptionByLabel(findTestObject('Page_CURA Healthcare Service/select_Facility'), 'Hongkong CURA Healthcare Center', 
    false)

WebUI.check(findTestObject('Page_CURA Healthcare Service/input_Apply for hospital readmission'))

WebUI.check(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Medicare_programs'))
