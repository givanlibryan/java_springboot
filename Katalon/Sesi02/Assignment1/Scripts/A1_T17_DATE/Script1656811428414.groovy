...
WebUI.setText(findTestObject('Object Repository/APPOINTMENT/input_Visit Date'), '', FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/APPOINTMENT CONFIRMATION/p_Appointment booked'), 
    0)
