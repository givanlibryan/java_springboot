...
WebUI.setText(findTestObject('Product/Qty box'), '4')
...
WebUI.verifyElementPresent(findTestObject('Cart/Cart label/Product has been added to your cart'), 0)

WebUI.verifyElementPresent(findTestObject('Cart/Action button/a_View cart'), 0)

WebUI.click(findTestObject('Cart/Action button/a_Proceed to cart'))

WebUI.verifyElementPresent(findTestObject('Cart/Action button/a_Remove product'), 0)

WebUI.verifyElementPresent(findTestObject('Cart/Cart label/Product image'), 0)

WebUI.verifyElementPresent(findTestObject('Cart/Cart label/Subtotal'), 0)

WebUI.verifyElementPresent(findTestObject('Cart/Cart label/Total'), 0)
