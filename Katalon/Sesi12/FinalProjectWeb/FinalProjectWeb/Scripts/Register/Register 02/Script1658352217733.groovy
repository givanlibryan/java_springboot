...
WebUI.click(findTestObject('Object Repository/Register/Register page/btn_Submit register'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Register/Register page/div_Your passwords do not match'), 0)
